...
function tswcust_custom_profile_plugin_activation() {

        return false;

}

function tswcust_custom_profile_plugin_deactivation() {

 
    global $wp_post_types;
    if ( isset( $wp_post_types[ 'custom_profile' ] ) ) {
        unset( $wp_post_types[ 'custom_profile' ] );
        return true;
    }
    return false;
...
register_activation_hook( __FILE__, 'tswcust_custom_profile_plugin_activation');
register_deactivation_hook( __FILE__, 'tswcust_custom_profile_plugin_deactivation');
